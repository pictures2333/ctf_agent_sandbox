...
def main(argv: list[str] | None = None) -> int:
    ...
    # Dispatch `stop-container` command.
    if args.command == "stop-container":
        stop_container(args.container_id)
        return 0

    # Keep parser-driven error flow for unknown commands.
